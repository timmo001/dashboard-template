...
LABEL \
    ...
    org.label-schema.name="Dashboard" \
    org.label-schema.schema-version="1.0" \
    org.label-schema.url="https://timmo.dev/dashboard" \
    org.label-schema.usage="https://github.com/timmo001/dashboard/tree/master/README.md" \
    org.label-schema.vcs-ref=${BUILD_REF} \
    org.label-schema.vcs-url="https://github.com/timmo001/dashboard" \
